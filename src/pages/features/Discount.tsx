        ...
        <div className="flex-1 flex flex-col gap-2 shrink-0">
          <div className="bg-purple-50 rounded-2xl p-3 border-2 border-purple-200">
            ...
            <div className="grid grid-cols-3 gap-2">
              <button onClick={() => applyDiscount(0.3, '3折')} className={`p-2 sm:p-3 rounded-xl text-base sm:text-xl font-black border-b-4 active:border-b-0 active:translate-y-1 transition-all shadow-sm ${discount === 0.3 ? 'bg-purple-600 border-purple-800 text-white' : 'bg-white border-slate-300 text-slate-700 hover:bg-slate-50'}`}>3折</button>
              <button onClick={() => applyDiscount(0.4, '4折')} className={`p-2 sm:p-3 rounded-xl text-base sm:text-xl font-black border-b-4 active:border-b-0 active:translate-y-1 transition-all shadow-sm ${discount === 0.4 ? 'bg-purple-600 border-purple-800 text-white' : 'bg-white border-slate-300 text-slate-700 hover:bg-slate-50'}`}>4折</button>
              <button onClick={() => applyDiscount(0.5, '5折')} className={`p-2 sm:p-3 rounded-xl text-base sm:text-xl font-black border-b-4 active:border-b-0 active:translate-y-1 transition-all shadow-sm ${discount === 0.5 ? 'bg-red-500 border-red-700 text-white' : 'bg-white border-slate-300 text-red-600 hover:bg-slate-50'}`}>5折</button>
              ...
              <button onClick={() => applyDiscount(0.95, '95折')} className={`p-2 sm:p-3 rounded-xl text-base sm:text-xl font-black border-b-4 active:border-b-0 active:translate-y-1 transition-all shadow-sm ${discount === 0.95 ? 'bg-purple-600 border-purple-800 text-white' : 'bg-white border-slate-300 text-slate-700 hover:bg-slate-50'}`}>95折</button>
            </div>
          </div>
